    ...
    <div className="teamWeek">
      ...
      <div className="weekPitch">
        <div className="weekWrapper">
          {teamOfTheWeek.slice(0, 2).map((item, index) => {
            return (
              <div key={index}>
        ...
        <div className="weekWrapper" style={{ width: '700px' }}>
          {teamOfTheWeek.slice(2, 6).map((item, index) => {
            return (
              <div key={index}>
                <img className="weekLogo" src={item.logo} alt={item.logo} />
                <div style={{ fontSize: '10px', marginTop: '5px' }}>
        ...
        <div className="weekWrapper" style={{ width: '700px' }}>
          {teamOfTheWeek.slice(6, 10).map((item, index) => {
            return (
              <div key={index}>
                <img className="weekLogo" src={item.logo} alt={item.logo} />
                <div style={{ fontSize: '10px', marginTop: '5px' }}>
        ...
        <div className="weekWrapper" style={{ width: '700px' }}>
          <div>
            <img
              className="weekLogo"
              src={teamOfTheWeek[10].logo}
              alt={teamOfTheWeek[10].logo}
            />
            <div style={{ fontSize: '10px', marginTop: '5px' }}>
              {teamOfTheWeek[10].teamName}
            </div>
            <div style={{ fontWeight: '900', fontSize: '18px' }}>
              {teamOfTheWeek[10].name}
            </div>
